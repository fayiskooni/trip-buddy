...
export default function JoinedTripsPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-[150px] -z-10 -translate-x-1/3 translate-y-1/3 mix-blend-screen" />
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">My Joined Trips</h1>
            <p className="text-xl text-muted-foreground max-w-2xl">
              All the amazing journeys you are a part of. Get ready for your next adventure!
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24 glass rounded-3xl border border-muted/50">
            <h3 className="text-2xl font-bold mb-2">No joined trips yet</h3>
            <p className="text-muted-foreground mb-6">Explore available packages and join an adventure!</p>
              ...
              <Card key={trip.id} className="group overflow-hidden rounded-[2rem] border-muted/20 bg-background hover:shadow-xl transition-all duration-500 flex flex-col h-full shadow-sm">
                ...
                <CardContent className="p-6 pt-6 flex-grow flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold text-sm shrink-0 uppercase">
